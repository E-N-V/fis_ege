...
export const SearchPOST = async (req: Request, res: Response): Promise<any> => {
	...
	let applicants = await Applicant.find({
		where: {
			 ...
			 */
			date_zayv: Between(
				req.body.data_zayav_ot
					? req.body.data_zayav_ot
					: Date_,
				req.body.data_zayav_do
					? req.body.data_zayav_do
					: Date_
			),
			...
			obshaga: req.body.obshaga
				...
				: In(["Да", "Нет"]),
			sex: req.body.sex
				? isArray(req.body.sex)
					? In(req.body.sex)
					: req.body.sex
				: In(["М", "Ж"]),
			birthday: Between(
				req.body.birthday_ot
					? req.body.birthday_ot
					: Date_,
				req.body.birthday_do
					? req.body.birthday_do
					: Date_
			),
			...
			god_okonchania: Between(
				req.body.god_okonchania_ot
					? req.body.god_okonchania_ot
					: Date_,
				req.body.god_okonchania_do
					? req.body.god_okonchania_do
					: Date_
			),
			osobie_yspexi_v_echebe: req.body.osobie_yspexi_v_echebe
			? req.body.osobie_yspexi_v_echebe : Not(""),
			...
			vstup_ispitanie_1: Between(
				req.body.vstup_ispitanie_1_ot
					? req.body.vstup_ispitanie_1_ot
					: "0",
				req.body.vstup_ispitanie_1_do
					? req.body.vstup_ispitanie_1_do
					: "5"
			),
			avg_ball_obrazovanie_2: Between(
				req.body.avg_ball_obrazovanie_2_ot
					? req.body.avg_ball_obrazovanie_2_ot
					: "0",
				req.body.avg_ball_obrazovanie_2_do
					? req.body.avg_ball_obrazovanie_2_do
					: "5"
			),
			reshenie_komissi: req.body.reshenie_komissi
			? req.body.reshenie_komissi : Not("")
		},
